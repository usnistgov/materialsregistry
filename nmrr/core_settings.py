...
SAML2_AUTH = {
    ...
    'ASSERTION_URL': 'https://test-materials.registry.nist.gov', # Custom URL to validate incoming SAML requests against
    'ENTITY_ID': 'https://test-materials.registry.nist.gov/saml2_auth/acs/', # Populates the Issuer element in authn request
    ...
    'SIGNOUT_SLO': {
        'CERT':  '/srv/curator/certs/test-materials.registry.nist.gov-self.crt',
        'KEY':   '/srv/curator/certs/test-materials.registry.nist.gov-self.key'
    }
}
